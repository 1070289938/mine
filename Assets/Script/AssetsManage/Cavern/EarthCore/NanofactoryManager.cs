...
// 纳米工厂
public class NanofactoryManager : MonoBehaviour
{
    ...
    string resourceName = "纳米工厂";
    string resourceDescription = "纳米工厂会自动消耗材料来制造纳米材料";
    int resourceQuantity = 0;

    string btnText = "建造";


    double baseYield = 0.01;//纳米材料基础产量

    Dictionary<ResourceType, double> depleted;//每个成品消耗的资源
    readonly FacilityType type = FacilityType.Nanofactory;
    ...
    {
        //获取到纳米材料的制作配方
        depleted = ResourceManager.Instance.formula[ResourceType.Nanomaterials];
    ...
    void Output()
    {
        ...
        facilityPanelManager.UpdateOutPut(ResourceType.Nanomaterials, secondCount, false);//更新产出资源
